...
(function(){
	...
	var autoBattleUsableMessage = String(parameters['Auto Battle Usable Message'] || '自动战斗中　按Shift解除');
	var autoBattleMessage = String(parameters['Auto Battle Message'] || 'Shift开启自动战斗');
